...
const ConfirmPickupPage = () => {
  ...
  const handleBack = () => {
    // navigate(-1);
    setRegistrationSteps(5); // Go back to Service Options Page
  };

  const handleConfirm = () => {
    // navigate('/booking-info');
    setRegistrationSteps(7); 
  };
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-white p-4 rounded-t-3xl shadow-lg">
        <h2 className="text-xl font-bold mb-4 text-salik-darkGray">Confirm Car Pickup Location</h2>
        ...
        variant='primary'
          ...
          className="w-full py-4 rounded-md font-bold h-[3rem] transition-colors"
        >
          Confirm Location
        </Button>
      </div>
