...
const ConfirmPickupPage = () => {
    ...
    const [bookingInfo, setBookingInfo] = React.useState(booking);
                ...
                <>
                    ...
                    <div className="absolute bottom-0 left-0 right-0 bg-white p-4 rounded-t-3xl shadow-lg">
                        ...
                        <button
                            ...
                            className="w-full bg-gray-500 text-white py-4 rounded-md font-bold hover:bg-opacity-90 transition-colors"
                        >
                            Confirm PickUp
                        </button>
                    </div>
