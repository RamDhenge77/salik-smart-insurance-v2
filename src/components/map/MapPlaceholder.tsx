      ...
      {isLoading && (
        <div className="absolute inset-0 flex items-center justify-center bg-gray-100 z-10">
          <div className="flex flex-col items-center">
            <div className="w-8 h-8 border-4 border-salik-gray-500 border-t-transparent rounded-full animate-spin mb-2"></div>
            <p className="text-salik-gray-600">Loading map...</p>
          </div>
        </div>
      )}
