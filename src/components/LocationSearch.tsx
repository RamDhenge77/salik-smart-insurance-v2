...
interface LocationSearchProps {
  ...
  onSelect: (location: { name: string; address: string; coordinates?: [number, number] }) => void;
  value?: string;
}
...
const LocationSearch: React.FC<LocationSearchProps> = ({
  ...
  const initAutocomplete = () => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description: "Could not initialize location search. Please check your API key.",
        variant: "destructive"
      });
    }
  };
  ...
  const handlePlaceSelect = () => {
    try {
      ...
      // Convert coordinates to the [number, number] tuple format expected by BookingContext
    ...
    <div className="relative">
      <div className="relative">
        ...
        <input
          ...
          className="w-full p-4 pl-10 bg-gray-100 rounded-md pr-10"
